/**
  ...
  ******************************************************************************
  */
#ifndef AI_MAINTENANCE_H
#define AI_MAINTENANCE_H

#include "maintenance_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_MAINTENANCE_MODEL_NAME          "maintenance"
#define AI_MAINTENANCE_ORIGIN_MODEL_NAME   "balanced_model"

/******************************************************************************/
#define AI_MAINTENANCE_ACTIVATIONS_ALIGNMENT   (4)
#define AI_MAINTENANCE_INPUTS_IN_ACTIVATIONS   (4)
#define AI_MAINTENANCE_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_MAINTENANCE_IN_NUM        (1)

AI_DEPRECATED
#define AI_MAINTENANCE_IN \
  ai_maintenance_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_MAINTENANCE_IN_SIZE { \
  AI_MAINTENANCE_IN_1_SIZE, \
}
#define AI_MAINTENANCE_IN_SIZE_BYTES { \
  AI_MAINTENANCE_IN_1_SIZE_BYTES, \
}
#define AI_MAINTENANCE_IN_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MAINTENANCE_IN_1_CHANNEL     (5)
#define AI_MAINTENANCE_IN_1_SIZE        (5)
#define AI_MAINTENANCE_IN_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_MAINTENANCE_OUT_NUM       (1)

AI_DEPRECATED
#define AI_MAINTENANCE_OUT \
  ai_maintenance_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_MAINTENANCE_OUT_SIZE { \
  AI_MAINTENANCE_OUT_1_SIZE, \
}
#define AI_MAINTENANCE_OUT_SIZE_BYTES { \
  AI_MAINTENANCE_OUT_1_SIZE_BYTES, \
}
#define AI_MAINTENANCE_OUT_1_FORMAT      (AI_BUFFER_FORMAT_FLOAT)
#define AI_MAINTENANCE_OUT_1_CHANNEL     (5)
#define AI_MAINTENANCE_OUT_1_SIZE        (5)
#define AI_MAINTENANCE_OUT_1_SIZE_BYTES  (20)

/******************************************************************************/
#define AI_MAINTENANCE_N_NODES (10)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup maintenance
 ...
 * @ref ai_maintenance_create. Both the activations memory buffer 
 ...
 * using @ref ai_maintenance_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_maintenance_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_maintenance_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_MAINTENANCE_*
 * defines into file @ref maintenance.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_maintenance_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_MAINTENANCE_H */
